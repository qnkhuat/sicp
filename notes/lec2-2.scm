...
; beside painter1 painter2 => painter1 on the left, painter2 on the right
; below  painter1 painter2 => painter1 on top, painter2 at the bottom
; flip-vert painter
; flip-horiz painter
...
(define (square-of-four tl tr bl br)
  (lambda (painter)
    (let ((top (beside (tl painter) (tr painter)))
          (bottom (beside (bl paitner) (br paitner))))
      (below bottom top))))
